        ...
        protected override void Seed(SinExWebApp20328381.Models.SinExDatabaseContext context)
        {
            ...
            context.ShipmentStatusHistories.AddOrUpdate(
               ...
               new ShipmentStatusHistory { ShipmentStatusHistoryId = 1, WaybillId = 1, Date = new DateTime(2017, 04, 06), Time = new DateTime(2017, 04, 06, 13, 35, 00), TimeValue = "13:35", Description = "Picked up ", DeliveredPlace = null, DeliveredPerson = null, Location = "Hong Kong", Remarks = "Vehicle 34 ", Status = "PickedUp" },
                ...
                new ShipmentStatusHistory { ShipmentStatusHistoryId = 19, WaybillId = 4, Date = new DateTime(2017, 05, 02), Time = new DateTime(2017, 05, 02, 08, 30, 00), TimeValue = "08:30", Description = "Picked up", DeliveredPlace = null, DeliveredPerson = null, Location = "Hong Kong", Remarks = "Vehicle 12", Status = "PickedUp" },
                new ShipmentStatusHistory { ShipmentStatusHistoryId = 20, WaybillId = 4, Date = new DateTime(2017, 05, 02), Time = new DateTime(2017, 05, 02, 10, 00, 00), TimeValue = "10:00", Description = "At local sort facility", DeliveredPlace = null, DeliveredPerson = null, Location = "Shatin", Remarks = "", Status = "PickedUp" },
                new ShipmentStatusHistory { ShipmentStatusHistoryId = 21, WaybillId = 4, Date = new DateTime(2017, 05, 02), Time = new DateTime(2017, 05, 02, 10, 35, 00), TimeValue = "10:35", Description = "Left origin ", DeliveredPlace = null, DeliveredPerson = null, Location = "Shatin", Remarks = "Vehicle 667 ", Status = "PickedUp" }
            );
